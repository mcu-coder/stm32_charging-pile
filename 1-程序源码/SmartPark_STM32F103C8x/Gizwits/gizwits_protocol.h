...
* @{
*/
#define PRODUCT_KEY "f082aa6697b240a89db4aac310c9cd68"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "4da9216067624fb696da55ad0b506420"
...
#define temp_max_RATIO                         0.1
#define temp_max_ADDITION                      0
#define temp_max_MIN                           0
#define temp_max_MAX                           1000
#define temp_min_RATIO                         0.1
#define temp_min_ADDITION                      0
#define temp_min_MIN                           0
#define temp_min_MAX                           1000
#define humi_max_RATIO                         0.1
#define humi_max_ADDITION                      0
#define humi_max_MIN                           0
#define humi_max_MAX                           1000
#define humi_min_RATIO                         0.1
#define humi_min_ADDITION                      0
#define humi_min_MIN                           0
#define humi_min_MAX                           1000
#define gas_max_RATIO                         1
#define gas_max_ADDITION                      0
#define gas_max_MIN                           0
#define gas_max_MAX                           65535
...
#define Humi_MIN                           0
#define Humi_MAX                           990
#define Gas_RATIO                         0.1
#define Gas_ADDITION                      0
#define Gas_MIN                           0
#define Gas_MAX                           1000
#define EnterNum_RATIO                         1
#define EnterNum_ADDITION                      0
#define EnterNum_MIN                           0
#define EnterNum_MAX                           100000
#define ExitNum_RATIO                         1
#define ExitNum_ADDITION                      0
#define ExitNum_MIN                           0
#define ExitNum_MAX                           100000
/**@} */
...
typedef struct {
    ...
    float valuehumi_max;
    float valuehumi_min;
    uint32_t valuegas_max;
    float valueTemp;
    float valueHumi;
    float valueGas;
    uint32_t valueEnterNum;
    uint32_t valueExitNum;
} dataPoint_t;
...
typedef struct {
    uint8_t flagMode:1;
    uint8_t flagtemp_max:1;
    uint8_t flagtemp_min:1;
    uint8_t flaghumi_max:1;
    uint8_t flaghumi_min:1;
    uint8_t flaggas_max:1;
} attrFlags_t;
...
typedef struct {
    ...
    uint16_t valuehumi_max;
    uint16_t valuehumi_min;
    uint16_t valuegas_max;
} attrVals_t;
